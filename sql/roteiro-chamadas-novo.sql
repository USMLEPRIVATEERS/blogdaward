...
INSERT INTO roteiro_jornada (tipo, titulo, grupo, posicao) VALUES
        ...
        ('call_guilherme_anki_update', 'Guilherme: revisando o seu Anki', 'imersao', 4),
        ('call_marcos_myintealth_conta', 'Marcos: criando a sua conta no Myintealth', 'imersao', 5),
        ('call_marcos_notarycam', 'Marcos: reconhecendo os documentos no NotaryCam', 'imersao', 6),
        ('call_iria_visto', 'Iria: como funciona o visto para os Estados Unidos', 'imersao', 9),
        ('call_iria_familia', 'Iria: conversando com a família sobre a decisão do USMLE', 'imersao', 10),
        ('call_iria_financeiro', 'Iria: planejando o lado financeiro da jornada', 'imersao', 11),
        ('call_marcos_ajuste_cronograma', 'Marcos: ajustando o seu cronograma de estudos', 'seguimento', 12),
        ('call_iria_system', 'Iria: avaliando a conclusão de um system', 'seguimento', 13),
        ('call_iria_orientacoes', 'Iria: orientações gerais sobre a sua preparação', 'seguimento', 14);
...
INSERT INTO roteiro_step (step, tipo, titulo, grupo, posicao) VALUES
        ...
        ('step1', 'call_marcos_myintealth_final', 'Marcos: finalizando a inscrição no Myintealth para o Step 1', 'imersao', 7),
        ('step1', 'call_iria_materiais', 'Iria: quais materiais de estudo usar na preparação para o Step 1', 'imersao', 8),
        ...
        ('step2ck', 'call_marcos_myintealth_final__s2', 'Marcos: finalizando a inscrição no Myintealth para o Step 2 CK', 'imersao', 7),
        ('step2ck', 'call_iria_materiais__s2', 'Iria: quais materiais de estudo usar na preparação para o Step 2 CK', 'imersao', 8),
        ...
        ('step3', 'call_iria_materiais__s3', 'Iria: quais materiais de estudo usar na preparação para o Step 3', 'imersao', 8),
