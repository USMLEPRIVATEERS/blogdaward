...
// Google Apps Script Backend - v2.6 FIX setSharing Access Denied
// ============================================
//
...
function doGet(e) {
  try {
    ...
    // STATUS DA API
      ...
      result = {
        success: true,
        message: 'Ward Academy Research Folders API v2.6',
        status: 'Working - Includes SUBMISSION subfolders + check missing + safe sharing',
...
function createProjectFolderStructure(projectTitle) {
  try {
    ...
    safeSharingSet(protocol, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
    subfolders['PROTOCOL'] = {
      id: protocol.getId(),
      url: protocol.getUrl()
    };
    ...
    safeSharingSet(databases, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
    ...
    safeSharingSet(fullText, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
    ...
    safeSharingSet(included, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
    subfolders['INCLUDED'] = {
      id: included.getId(),
      url: included.getUrl()
    };
    ...
    safeSharingSet(dataExtraction, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
    ...
    safeSharingSet(forestPlots, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
    ...
    safeSharingSet(riskOfBias, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
    ...
    safeSharingSet(submission, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
    ...
    safeSharingSet(tables, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
    ...
    safeSharingSet(figures, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
    ...
    safeSharingSet(abstract, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
    ...
    safeSharingSet(manuscript, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
    ...
    safeSharingSet(supplementary, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
    ...
    safeSharingSet(coverLetter, DriveApp.Access.ANYONE_WITH_LINK, DriveApp.Permission.EDIT);
...
function uploadFileToFolder(folderId, fileName, fileContent, mimeType) {
  try {
    ...
    // Tentar configurar permissões (pode falhar por politica da conta)
